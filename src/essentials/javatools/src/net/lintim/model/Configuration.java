...
public class Configuration {
    ...
    public String getStringValue(String name) throws DataInconsistentException{
        ...
        if(name.equals("default_activities_periodic_file") && data.keySet().contains("use_buffered_activities") && this.getBooleanValue("use_buffered_activities")){
				return data.get("default_activity_buffer_file");
		}
