...
public class SolveDSLTT2 {
    ...
    private static final Logger logger = new Logger(SolveDSLTT2.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.info("Begin computation of dsl tt 2 stop location");
            ...
            DSLTT2 dsltt = new DSLTT2(fds, ces, demand, parameters.getWaitingTime(), tt, distance);
            logger.debug("done!");
